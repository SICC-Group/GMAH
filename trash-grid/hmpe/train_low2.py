...
from trainer.v2_lowtrain import v2low_train
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--task", type=str, default=f'v2-low-{t}-norm')
...
if __name__ == '__main__':
    ...
    # =========Logger===============
    log_path = os.path.join(os.getcwd(), 'log', 'hmpev2/', args.task)
    ...
    obs_shape = env.observation_space + env.goal_space
    # print(obs_shape)
