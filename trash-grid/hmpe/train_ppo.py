...
from trainer.ppo_train import ppo_train_policy as ppo_trainer
from trainer.ppo_train import ppo_train_smac_policy as ppo_smac_trainer
...
if __name__ == '__main__':
    ...
    if args.env_name == 'hmpe':
        ...
        trainer = ppo_smac_trainer
    
    if args.env_name == 'hmpe':
        run_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                        0] + "/results") / args.env_name / args.exp_name / args.alg_name
    else:
        run_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                        0] + "/results") / args.env_name / args.map_name / args.exp_name / args.alg_name
    ...
    loss = trainer(env, policy, args.num_episodes_step, logger, env.num_agents, args.buffer_size, max_cycles, run_dir, args.test_episodes, args.n_rollout_threads, args.log_interval, args.eval_interval)
